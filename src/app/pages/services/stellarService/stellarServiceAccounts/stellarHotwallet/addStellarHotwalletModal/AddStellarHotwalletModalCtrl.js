(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarService.stellarServiceAccounts')
        .controller('AddStellarHotwalletModalCtrl', AddStellarHotwalletModalCtrl);

    function AddStellarHotwalletModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler) {
