(function () {
    ...
    angular.module('BlurAdmin.pages.services.notificationService.editNotificationServiceNotification.email')
        .controller('EditNotificationServiceNotificationEmailCtrl', EditNotificationServiceNotificationEmailCtrl);

    /** @ngInject */
    function EditNotificationServiceNotificationEmailCtrl($scope,$http,localStorageManagement,notificationHtmlTags,
