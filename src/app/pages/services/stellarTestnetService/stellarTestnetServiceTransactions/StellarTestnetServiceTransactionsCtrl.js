(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceTransactions')
        .controller('StellarTestnetServiceTransactionsCtrl', StellarTestnetServiceTransactionsCtrl);

    /** @ngInject */
    function StellarTestnetServiceTransactionsCtrl($scope,$http,localStorageManagement,$uibModal,toastr,dateFiltersService,
        ...
        $scope.openModal = function (page, size,transaction) {
            $uibModal.open({
                ...
                templateUrl: page,
                size: size,
                controller: 'StellarTestnetServiceTransactionsModalCtrl',
                resolve: {
