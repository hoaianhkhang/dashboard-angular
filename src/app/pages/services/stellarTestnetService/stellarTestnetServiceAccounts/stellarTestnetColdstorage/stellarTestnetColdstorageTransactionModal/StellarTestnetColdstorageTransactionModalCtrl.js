(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('StellarTestnetColdstorageTransactionModalCtrl', StellarTestnetColdstorageTransactionModalCtrl);

    function StellarTestnetColdstorageTransactionModalCtrl($uibModalInstance,$scope,uuid,$state,
