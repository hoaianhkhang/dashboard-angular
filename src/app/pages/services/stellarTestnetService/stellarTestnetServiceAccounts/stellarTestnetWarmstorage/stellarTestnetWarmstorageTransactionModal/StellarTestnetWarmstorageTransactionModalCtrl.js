(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('StellarTestnetWarmstorageTransactionModalCtrl', StellarTestnetWarmstorageTransactionModalCtrl);

    function StellarTestnetWarmstorageTransactionModalCtrl($uibModalInstance,$scope,uuid,$state,
