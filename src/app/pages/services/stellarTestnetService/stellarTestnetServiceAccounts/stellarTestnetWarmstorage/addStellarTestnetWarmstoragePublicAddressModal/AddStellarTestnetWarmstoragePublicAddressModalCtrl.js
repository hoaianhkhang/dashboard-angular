(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('AddStellarTestnetWarmstoragePublicAddressModalCtrl', AddStellarTestnetWarmstoragePublicAddressModalCtrl);

    function AddStellarTestnetWarmstoragePublicAddressModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler) {
