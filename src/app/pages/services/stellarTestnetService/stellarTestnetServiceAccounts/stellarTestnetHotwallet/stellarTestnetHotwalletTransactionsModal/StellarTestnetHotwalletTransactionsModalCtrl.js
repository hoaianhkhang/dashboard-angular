(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('StellarTestnetHotwalletTransactionsModalCtrl', StellarTestnetHotwalletTransactionsModalCtrl);

    function StellarTestnetHotwalletTransactionsModalCtrl($uibModalInstance,$scope,uuid,localStorageManagement,$state,
