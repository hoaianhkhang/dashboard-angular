(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('StellarColdstorageTransactionModalCtrl', StellarColdstorageTransactionModalCtrl);

    function StellarColdstorageTransactionModalCtrl($uibModalInstance,$scope,uuid,$state,
