(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('StellarWarmstorageTransactionModalCtrl', StellarWarmstorageTransactionModalCtrl);

    function StellarWarmstorageTransactionModalCtrl($uibModalInstance,$scope,uuid,$state,
