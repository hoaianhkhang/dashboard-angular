(function () {
    ...
    /** @ngInject */
    function StellarWarmstorageCtrl($scope,localStorageManagement,errorHandler,$http,$uibModal,$state,cleanObject,
        ...
        $scope.openWarmstorageModal = function (page, size,transaction) {
            vm.theModal = $uibModal.open({
                ...
                templateUrl: page,
                size: size,
                controller: 'StellarWarmstorageTransactionModalCtrl',
                resolve: {
