...
(function () {
    ...
    function demoSetupService($rootScope, $http, localStorageManagement, environmentConfig, errorHandler, Rehive,
                              currencyModifiers, serializeFiltersService, $filter, toastr, $location) {
        ...
        return {
            ...
            setupRewardsService: function (adminAccountRef) {
                ...
                var rewardsCampaign1 = {
                        ...
                        reward_total: currencyModifiers.convertToCents(5000, vm.demoCurrency.divisibility),
                        reward_amount: currencyModifiers.convertToCents(20.00, vm.demoCurrency.divisibility),
                    ...
                    rewardsCampaign2 = {
                        ...
                        start_date: moment(date1).format('YYYY-MM-DD') + 'T00:00:00Z',
                        end_date: moment(date2).format('YYYY-MM-DD') + 'T00:00:00Z',
                        reward_total: currencyModifiers.convertToCents(2500, vm.demoCurrency.divisibility),
                        reward_amount: currencyModifiers.convertToCents(10.00, vm.demoCurrency.divisibility),
                        account: adminAccountRef,
                        reward_percentage: null,
                        amount_type: "fixed",
                        status: 'active',
